...
class _MeterReaderHistoryPageState extends State<MeterReaderHistoryPage> {
  ...
  Future<void> _loadCompletedReadings() async {
    ...
    try {
      ...
      setState(() {
        ...
        _filteredReadings = completedReadings;
        _isLoading = false;
      });
    } catch (e) {
      setState(() {
  ...
  void _filterReadings() {
    ...
    if (query.isEmpty) {
      setState(() {
        _filteredReadings = List.from(_completedReadings);
      });
      return;
    }

    setState(() {
      _filteredReadings = _completedReadings.where((reading) {
        ...
        final meter = (consumer['water_meter_no'] ?? '')
            .toString()
            .toLowerCase();
        final address = (account?['full_address'] ?? '')
            .toString()
            .toLowerCase();
    ...
    return Scaffold(
      ...
      body: _isLoading
          ...
          : Column(
              children: [
                // Search Bar
                if (!_isLoading && _completedReadings.isNotEmpty)
                  Container(
                ...
                // Content
                Expanded(
                  child: _completedReadings.isEmpty
                      ? Center(
                          child: Column(
                      ...
                      : RefreshIndicator(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final consumer =
                                  reading['consumers'] as Map<String, dynamic>;
                              final account =
